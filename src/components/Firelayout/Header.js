                                ...
                                <div className="call-div d-lg-block d-none">
                                    {/* <div className="d-flex align-items-center">
                                        <svg width="40" className='me-3' height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M21.375 10.8335C21.375 10.8335 23.514 11.028 26.2364 13.7503C28.9587 16.4727 29.1532 18.6117 29.1532 18.6117" stroke="#141414" stroke-width="1.5" stroke-linecap="round" />
                                            <path d="M22.0232 14.0742C22.0232 14.0742 22.9306 14.3335 24.2918 15.6947C25.653 17.0559 25.9123 17.9633 25.9123 17.9633" stroke="#141414" stroke-width="1.5" stroke-linecap="round" />
